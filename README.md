# Docker basic commands guide for
## Ft_server
` From subject pdf `: This is a System Administration subject. You will discover Docker and you will set up your first web server.
